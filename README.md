...
var myExperianAPI = new Experian(CLIENT_ID, CLIENT_SECRET, VERSION, SANDBOX);

//Login Method - Returns a promise
myExperianAPI.login(username, password).then((result) => {
  //Make a request to the business - Business Headers API with a BIN and Subcode
  myExperianAPI.business.us
    .headers({
      subcode: "1234567",
      bin: "1234567",
    })
