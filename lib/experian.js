...
Experian.DEFAULT_SANDBOX_BASE_PATH = "https://us-api.experian.com";
 ...
 */
function Experian(clientId, clientSecret, version, sandbox) {
  ...
  this._api = {
    ...
    basePath: sandbox ? DEFAULT_SANDBOX_BASE_PATH : Experian.DEFAULT_BASE_PATH,
