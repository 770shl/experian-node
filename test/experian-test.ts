...
const EXPERIAN_CLIENT_ID: string = 'XXXXXXX';
const EXPERIAN_CLIENT_SECRET: string = 'XXXXXXX';
const EXPERIAN_CLIENT_ID_CONSCREDIT: string = 'XXXXXXX';
const EXPERIAN_CLIENT_SECRET_CONSCREDIT: string = 'XXXXXXX';
const VERSION: string = 'v1';

const experian: Experian = new Experian(
    EXPERIAN_CLIENT_ID,
...
describe('Experian API Module', function() {
    ...
    describe('Login API', function(done) {
        ...
        it('Will return a promise on successful login', function() {
            return expect(new Promise(function(resolve, reject) {
